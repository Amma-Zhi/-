...
export default function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-polka-dots text-slate-800 flex flex-col items-center justify-between font-sans relative overflow-x-hidden p-2 sm:p-4">
      ...
      {/* MAIN APP CONTAINER */}
      <div
        className={`w-full mx-auto flex items-center justify-center my-auto transition-all duration-300 ${
