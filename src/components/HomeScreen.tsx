...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  return (
    <div
      className={`bg-[#FFFDF8] rounded-[36px] border-[6px] border-[#FFF0F3] shadow-2xl overflow-hidden select-none relative my-2 transition-all duration-300 ${
        isLandscape
          ? 'w-full max-w-[860px] min-h-[440px] p-4 flex flex-col justify-between'
          : 'w-full max-w-[420px] min-h-[720px] p-4 flex flex-col justify-between'
      }`}
    >
