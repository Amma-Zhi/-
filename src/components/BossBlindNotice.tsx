  ...
  return (
    <div className="fixed inset-0 bg-pink-950/70 backdrop-blur-md z-50 flex items-center justify-center p-4 select-none">
      <motion.div
        ...
        className="w-full max-w-md bg-gradient-to-b from-white via-rose-50 to-pink-100 rounded-3xl p-6 sm:p-8 border-4 border-rose-400 shadow-2xl flex flex-col items-center gap-5 text-center"
      >
