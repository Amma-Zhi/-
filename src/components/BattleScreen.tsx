  ...
  return (
    <div
      className={`bg-[#EDF5FA] rounded-[36px] border-[6px] border-[#C6E2FF] shadow-2xl overflow-hidden select-none relative my-2 transition-all duration-300 ${
        isLandscape
          ? 'w-full max-w-[860px] min-h-[460px] h-[460px] p-3 flex flex-row justify-between gap-3'
          : 'w-full max-w-[420px] min-h-[730px] h-[730px] p-0 flex flex-col justify-between'
      }`}
    >
      ...
      {isLandscape ? (
        ...
        /* PORTRAIT LAYOUT */
        <div className="relative z-10 flex flex-col justify-between h-full min-h-[720px] overflow-hidden">
