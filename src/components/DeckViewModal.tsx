  ...
  return (
    <div className="fixed inset-0 bg-pink-950/60 backdrop-blur-md z-50 flex items-center justify-center p-3 sm:p-4 select-none">
      <motion.div
        ...
        className="w-full max-w-3xl bg-gradient-to-b from-white via-pink-50 to-rose-100 rounded-3xl p-4 sm:p-6 border-4 border-pink-300 shadow-2xl flex flex-col gap-4 max-h-[90vh] relative overflow-hidden"
      >
        <button
          onClick={onClose}
        ...
        <div className="flex-1 flex flex-col gap-4 overflow-y-auto pr-1">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2 flex-wrap p-2 bg-white/60 rounded-2xl border border-pink-200">
              {deck.map((card) => (
